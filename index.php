            ...
            <div class="row">
                <div class="col-lg-6 v-center">
                    <div class="header-heading">
                        <h1 class="wow fadeInUp" data-wow-delay=".2s">Website Designing & Development Agency</h1>
                        <p class="wow fadeInUp" data-wow-delay=".4s">India's top web development and design firm. Registered Company with 100% Trust. We offer our clients the highest-quality websites at an incredibly low cost. We've already finished more than 100 websites.
              </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="common-heading text-l">
                    ...
                    <h2>Web Designing Agency</h2>
                    <p>
                    Weblinet is an interactive web design company that offers cutting-edge marketing strategies to customers who want to push the envelope. The digital experience is at a crossroads between expectation and surprise, requiring a smart approach. </p>
                    <p class="quote">Web design solutions that are original and distinctive, lovingly made, and in step with contemporary trends.</p>
                    <p class="quote">We prefer to be seen as a digital art boutique rather than a factory that produces more than it can handle.</p>  
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading">
                    ...
                    <h2 class="mb30">Web Designing & Development Services</h2>
                </div>
            </div>
        </div>
                ...
                <div class="clients-logos text-center col-12">
                    <ul class="row text-center clearfix">
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.6s"
                            style="visibility: visible; animation-delay: 2.6s; animation-name: fadeIn;">
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.8s"
                            style="visibility: visible; animation-delay: 2.8s; animation-name: fadeIn;">
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="3s"
                            style="visibility: visible; animation-delay: 3s; animation-name: fadeIn;">
                            <div class="brand-logo"><img src="images/client/clients-4.png" alt="clients"
                                    class="img-fluid"></div>
                            <p>Premier Pipes, India</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="3.2s"
                            style="visibility: visible; animation-delay: 3.2s; animation-name: fadeIn;">
                            <div class="brand-logo"><img src="images/client/clients-1.png" alt="clients"
                                    class="img-fluid"></div>
                            <p>Dynamic, India</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="3.4s"
                            style="visibility: visible; animation-delay: 3.4s; animation-name: fadeIn;">
                            <div class="brand-logo"><img src="images/client/clients-7.png" alt="clients"
                                    class="img-fluid"></div>
                            <p>Fns Inc, India</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="3.6s"
                            style="visibility: visible; animation-delay: 3.6s; animation-name: fadeIn;">
                            <div class="brand-logo"><img src="images/client/clients-2.png" alt="clients"
                                    class="img-fluid"></div>
                            <p>RP School, India</p>
                        </li>
        ...
        <div class="row">
            <div class="col-lg-4 v-center">
                <div class="common-heading text-l">
                    ...
                    <p>A creative digital agency, Weblinet Studio focuses on design, programming (development), digital marketing, and client business growth.</p>
                </div>
            </div>
            <div class="col-lg-8">
